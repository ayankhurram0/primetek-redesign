...
export default function BlogFeatured() {
   return (
      <section className="py-20 border-b border-ink/10 bg-transparent">
         <div className="max-w-7xl mx-auto px-6">
            <motion.div
               initial={{ opacity: 0, scale: 0.98 }}
               whileInView={{ opacity: 1, scale: 1 }}
               className="relative glass rounded-[40px] border-ink/10 overflow-hidden group cursor-pointer"
            >
               <div className="flex flex-col lg:flex-row items-stretch">
                  ...
                  <div className="lg:w-1/2 p-12 lg:p-20 flex flex-col justify-center bg-transparent/40 backdrop-blur-3xl">
                     <div className="flex items-center gap-4 text-ink-subtle text-[9px] font-bold uppercase tracking-widest mb-6">
                        <span className="text-accent">By Operational Lead</span>
                        <span className="w-1 h-1 rounded-full bg-slate-800" />
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 12 MIN READ</span>
                     </div>
                     <h2 className="text-4xl md:text-5xl font-display font-medium text-ink mb-6 uppercase  leading-tight">
                        The Anatomy of <span className="text-gradient font-light">PBM Audits</span> in 2026.
                     </h2>
                     <p className="text-ink-muted font-light leading-relaxed mb-10 text-lg">
                     ...
                     <div className="flex items-center gap-6">
                        ...
                        <ArrowRight className="text-ink w-6 h-6 group-hover:translate-x-2 transition-transform" />
                     </div>
                  </div>
               </div>
            </motion.div>
