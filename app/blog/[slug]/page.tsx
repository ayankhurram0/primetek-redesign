      ...
      <section className="relative pt-40 pb-20 bg-[#f8fbfa] border-b border-teal-400/20">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          <StaggerContainer delayChildren={0.2} staggerChildren={0.15}>
            <StaggerItem>
              <div className="flex items-center justify-center gap-2 text-sm font-bold tracking-widest uppercase mb-6 text-teal-400">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <AnimationWrapper direction="up" distance={20} className="mt-12">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              ...
              <Link href="/blog" className="px-6 py-3 bg-teal-400/10 text-[#2b4c8c] font-bold uppercase tracking-wider text-xs rounded-full hover:bg-teal-400 hover:text-white transition-colors">
