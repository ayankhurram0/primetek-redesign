      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 h-auto">
          {values.map((v, i) => (
            <div
              key={v.title}
              className={`reveal-philosophy bg-[#04212a] p-10 rounded-[32px] border border-white/10 flex flex-col justify-between group overflow-hidden relative hover:bg-[#04212a]/80 hover:shadow-2xl transition-all`}
            >
