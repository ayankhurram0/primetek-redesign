...
const steps = [
  {
    number: "01",
    title: "We Saw the Shift",
    body: "Independent pharmacies—the heart of their communities—were being squeezed from every direction. Reimbursements down. Costs up. Corporate giants moving in. The playing field was no longer level.",
    img: vandm1,
  ...
  },
  {
    number: "02",
    title: "We Listened",
    body: "We didn't come in with assumptions. We came in with questions. We listened to owners, pharmacists, and teams. We walked the floors. We saw the real challenges—the ones slides and vendors ignore.",
    img: vandm2,
  ...
  {
    number: "03",
    title: "We Built a Plan",
    body: "We combined strategy, technology, and pharmacy-specific expertise to build solutions that drive real results. Not theory. Not fluff. A system designed to help independent pharmacies compete—and win.",
    img: vandm3,
  ...
  {
    number: "04",
    title: "We Get in the Game",
    body: "We don't hand you a playbook and walk away. We become your partner. Embedded. Responsive. Accountable. We move fast, adjust faster, and stay in the trenches with you.",
    img: vandm4,
  ...
  },
  {
    ...
    body: "This isn't a trend for us. It's a mission. We're building the future of independent pharmacy—together. Because when independents thrive, communities thrive.",
    img: vandm5,
