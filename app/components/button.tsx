...
export default function FancyButton({
    ...
    const getVariantClasses = () => {
        if (variant === "primary") {
            return "bg-gradient-to-r from-[#14b8a6] via-[#10b981] to-[#0f766e] bg-[length:200%_auto] hover:bg-right transition-all font-bold shadow-[inset_0px_2px_4px_rgba(255,255,255,0.4),0px_4px_25px_rgba(20,184,166,0.6)] ring-1 ring-white/20 border-transparent text-slate-950";
        }
