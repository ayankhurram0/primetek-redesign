...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#020817] text-white font-sans relative overflow-hidden">
      <div className="relative z-10 px-8 md:px-16 pt-10 pb-">
        <div className="flex flex-col md:flex-row justify-left gap-50">
          <div className="flex flex-col gap-3">
            {navLinks.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="text-white text-md 2xl:text-xl font-medium tracking-wide hover:text-teal-400 transition-colors"
              >
                {link.name}
              </Link>
            ))}
          ...
          <div className="flex flex-col gap-2 text-left">
            <span className="text-white/40 text-md uppercase tracking-wider">US</span>
            <p className="text-white/80 text-md 2xl:text-xl leading-relaxed">
              3 Gateway Center, 100 Mulberry Street<br />
              12th Floor, Suite 1243<br />
              Newark, NJ 07102
            </p>
            <p className="text-white/80 text-md 2xl:text-xl mt-2">
              +1 (908) 333-6252
            </p>
            <p className="text-white/80 text-md 2xl:text-xl mt-2">
        ...
        <div className="flex items-center gap-30">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex flex-col gap-1">
              <p className="text-white/60 text-md 2xl:text-xl"> 2026 ALL RIGHTS RESERVED</p>
              <Link href="#" className="text-white/40 text-md 2xl:text-xl hover:text-teal-400 transition-colors">PRIVACY POLICY</Link>
            </div>
          </div>
          <div className="flex justify-center gap-4 my-12">
            <a href="#" className="2xl:w-16 2xl:h-16 h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-teal-400 transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="2xl:w-8 2xl:h-8 w-6 h-6 text-white">
