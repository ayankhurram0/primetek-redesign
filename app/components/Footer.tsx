          ...
          <div className="flex flex-col gap-3">
            {navLinks.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="text-white text-md 2xl:text-xl font-medium tracking-wide hover:text-[#71c6a4] transition-colors"
              >
                {link.name}
              </Link>
            ))}
        ...
        <div className="flex items-center gap-30">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex flex-col gap-1">
              ...
              <Link href="#" className="text-white/40 text-md 2xl:text-xl hover:text-[#71c6a4] transition-colors">PRIVACY POLICY</Link>
            </div>
          </div>
          <div className="flex justify-center gap-4 my-12">
            <a href="#" className="2xl:w-16 2xl:h-16 h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#71c6a4] transition-colors">
