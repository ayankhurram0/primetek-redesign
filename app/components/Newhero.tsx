    ...
    <div className="relative min-h-screen bg-white flex flex-col items-center justify-center overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 flex items-end justify-end pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="relative h-[90%] w-auto flex items-end"
        >
          <Image 
            src={pharmacist} 
      ...
      <div className="relative z-10 w-full h-screen flex flex-col justify-between items-center py-16 px-6 pointer-events-none">
        ...
        <div className="flex flex-col items-center text-center max-w-6xl pointer-events-auto">
          <motion.div
            ...
            className="mb-6"
          >
            <div className="bg-[#76c8a3]/20 border border-[#76c8a3]/30 px-6 py-2 rounded-full">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-display font-bold leading-[1.1] tracking-tight text-[#2b4c8c]"
          >
