...
const studies: CaseStudyData[] = [
  {
    ...
    headlinePrimary: '$94,000 IN REVENUE',
    headlineAccent: 'RECOVERED IN 6 MONTHS',
    location: 'New Jersey',
    statValue: '$94K',
  ...
  },
  {
    ...
    headlinePrimary: 'PBM AUDIT AVOIDED —',
    headlineAccent: '$210,000 RECOUPMENT RISK ELIMINATED',
  ...
  },
  {
    ...
    headlinePrimary: '31% IMPROVEMENT IN',
    headlineAccent: 'OPERATIONAL EFFICIENCY OVER ONE YEAR',
    location: 'New York',
    statValue: '31%',
  ...
  },
  {
    ...
    headlinePrimary: 'REAL-TIME ALERT SYSTEM',
    headlineAccent: 'CATCHES $47,000 COMPLIANCE ISSUE BEFORE AUDIT',
