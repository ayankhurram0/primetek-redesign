      ...
      <div className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <motion.div
             ...
             viewport={{ once: true }}
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-white/[0.03] border border-white/10 text-rose-500 text-xl font-black uppercase tracking-[0.4em] mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group">
                  ...
                  <span className="text-lg font-black uppercase tracking-widest text-slate-500 group-hover:text-white transition-colors">{item}</span>
                </div>
              ))}
            </div>
          </motion.div>
            ...
            <div className="bg-[#020817] rounded-[44px] overflow-hidden">
               <div className="px-8 py-6 border-b border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-base font-black uppercase tracking-widest text-slate-600">PrimeTek Alert Feed — Live</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-ping" />
                    <span className="text-base font-black uppercase tracking-widest text-emerald-500">Active</span>
                  </div>
               </div>
                    ...
                    <div key={alert.id} className="p-6 bg-white/[0.02] border border-white/5 rounded-3xl hover:bg-white/[0.04] transition-colors group">
                      <div className="flex items-start justify-between mb-3">
                         <div className="flex items-center gap-4">
                           ...
                           <div>
                              <div className="text-lg font-black uppercase tracking-[0.2em] text-slate-500 group-hover:text-white transition-colors">{alert.title}</div>
                              <div className="text-base font-black uppercase tracking-widest mt-0.5 opacity-50">{alert.time}</div>
                           </div>
                         </div>
                         <div className={`text-base font-black uppercase tracking-widest px-3 py-1 rounded-full border border-current ${alert.color} opacity-70`}>
                           {alert.type}
                         </div>
                      </div>
               ...
               <button className="w-full py-6 text-center text-base font-black uppercase tracking-[0.3em] text-slate-600 hover:text-white hover:bg-white/5 transition-all border-t border-white/5 flex items-center justify-center gap-2">
