  ...
  return (
    <section className="relative pt-40 pb-20 border-b border-white/5 overflow-hidden bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          <h1 className="text-6xl md:text-8xl xl:text-8xl font-bold text-white mb-10 tracking-tighter uppercase leading-none">
            Support <span className="text-teal-400">Systems.</span>
          </h1>
